...
import { PencilIcon, TrashIcon, ClockIcon, BatteryIcon, CalendarIcon, ZapIcon, Search, X, Globe, CpuIcon, MapPin } from "lucide-react"
        ...
        {filtroUps.map((ups, index) => (
          <div key={index} className="overflow-hidden bg-white rounded-lg shadow-md">
            <div className="p-4 text-white bg-blue-900">
              <h3 className="text-xl font-semibold">{ups.modelo}</h3>
              ...
              <span className="font-bold">{ups.direccion_ip}</span>
              </div>
            </div>
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Baterías: {ups.baterias}</span>
                </div>
                <div className="flex items-center ">
                  <CpuIcon className="w-5 h-5 mr-2 text-purple-500" />
                  <span className="text-sm">Modulos: {ups.modulos}</span>
                </div>
              </div>
              <div className="mt-4">
            ...
            <div className="flex justify-end p-4 space-x-2 bg-gray-100">
              ...
              <Link to='/dashboard-empleados/historial_ups' className="p-2 text-white transition-colors bg-yellow-700 rounded-full hover:bg-yellow-800">
