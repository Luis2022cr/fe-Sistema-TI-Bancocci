...
const FiltroDirectorio: React.FC<FiltroDirectorioProps> = ({
  ...
  // Función para normalizar texto eliminando tildes y haciendo minúsculas
  ...
  // Filtrar las agencias basándose en el término de búsqueda
  const filteredAgencias = agencias.filter((agencia) =>
    normalizeText(agencia.nombre).includes(normalizeText(searchTerm))
  );
