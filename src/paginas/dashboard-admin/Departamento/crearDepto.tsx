...
import { CrearDtos, Post_Departamento } from '@/api_conexion/servicios/departamentos';


const CrearDepartamentos: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const nuevaDepartamento: Post_Departamento = {
        ...
        try {
            ...
            await CrearDtos (nuevaDepartamento);
    ...
    return (
        <div className="max-w-md mx-auto p-8 -mt-4">
            <h2 className="text-2xl font-bold mb-6 text-center">Agregar Departamento</h2>
